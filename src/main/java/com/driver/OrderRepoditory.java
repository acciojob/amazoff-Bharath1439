...
public class OrderRepoditory {
    ...
    public OrderRepoditory() {
    }

    public OrderRepoditory(HashMap<String, Order> orderdb, HashMap<String, DeliveryPartner> deliveryPartnerdb, HashMap<String, List<String>> orderToDeliveryPartner, HashMap<String, List<String>> partnerIdTimedb) {
